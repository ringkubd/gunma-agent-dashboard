...
export const AgentSettings = ({ apiUrl, getToken, tokenKeys = ['token', 'tk'], adminPrefix = '/api/admin/chat', showProviderSettings = true, }) => {
    ...
    return (_jsxs("div", { className: "gunma-settings", style: { padding: 24, maxWidth: 900 }, children: [_jsxs("div", { style: { display: 'flex', alignItems: 'center', gap: 12, marginBottom: 20 }, children: [_jsx(Bot, { size: 28, style: { color: 'var(--accent)' } }), _jsxs("div", { children: [_jsx("h2", { style: { margin: 0, fontSize: 20, fontWeight: 700 }, children: "Agent Settings" }), _jsx("p", { style: { margin: '4px 0 0', color: 'var(--text-muted)', fontSize: 13 }, children: "Control how Piku responds and which AI provider powers it." })] }), _jsx("button", { onClick: () => { fetchPrompts(); if (showProviderSettings)
                            fetchProvider(); }, style: { marginLeft: 'auto', background: 'none', border: '1px solid var(--border-color)', borderRadius: 8, padding: '8px 12px', cursor: 'pointer' }, title: "Refresh", children: _jsx(RefreshCw, { size: 16 }) })] }), showProviderSettings && (_jsxs("div", { style: { display: 'flex', gap: 8, marginBottom: 20 }, children: [_jsxs("button", { onClick: () => setActiveTab('prompt'), style: {
                            ...
                            color: activeTab === 'provider' ? '#fff' : 'var(--text-main)',
                                    ...
                                    }, children: [_jsx("div", { style: { fontWeight: 600, fontSize: 14, marginBottom: 2 }, children: opt.label }), _jsx("div", { style: { color: 'var(--text-muted)', fontSize: 12 }, children: opt.desc })] }, opt.value))) })] }), _jsxs("div", { style: { marginBottom: 24 }, children: [_jsxs("div", { style: { display: 'flex', justifyContent: 'space-between', marginBottom: 8 }, children: [_jsx("label", { style: { fontWeight: 600, fontSize: 14 }, children: "System Prompt" }), _jsxs("span", { style: { fontSize: 12, color: charCount > 3000 ? '#ef4444' : 'var(--text-muted)' }, children: [charCount, " characters"] })] }), _jsx("textarea", { value: systemPrompt, onChange: (e) => setSystemPrompt(e.target.value), style: {
