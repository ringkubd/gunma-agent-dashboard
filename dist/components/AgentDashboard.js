...
import { MessageSquare, Bot, User, Pause, Play, Send, Search, UserCircle, Mail, Trash2, ShoppingCart, CreditCard, AlertCircle, Info, CheckCircle2, XCircle, Loader2, Stamp, Eye, MapPin, Star, Activity, Package, } from 'lucide-react';
function moneyFmt(n) {
    return '¥' + Number(n || 0).toLocaleString('ja-JP');
}
function CustomerProfileModal({ profile, loading, onClose }) {
    if (!profile && !loading)
        return null;
    ...
    return (_jsx("div", { className: "gunma-profile-overlay", onClick: onClose, children: _jsxs("div", { className: "gunma-profile-modal", onClick: (e) => e.stopPropagation(), children: [_jsxs("div", { className: "gunma-profile-modal-head", children: [_jsx("div", { className: "initials-circle large", style: { backgroundColor: 'rgba(255,255,255,0.2)' }, children: getInitials(title) }), _jsxs("div", { children: [_jsx("h2", { children: title }), _jsxs("div", { className: "sub", children: [subtitle, profile?.is_guest ? ' · Guest' : ' · Registered customer'] })] }), _jsx("button", { className: "close", onClick: onClose, "aria-label": "Close", children: "\u2715" })] }), loading && !profile ? (_jsx("div", { style: { padding: 40, textAlign: 'center' }, children: _jsx(Loader2, { className: "animate-spin" }) })) : (_jsxs("div", { className: "gunma-profile-body", children: [_jsxs("div", { className: "gunma-profile-block wide", children: [_jsxs("h3", { children: [_jsx(Activity, { size: 14 }), " Overview"] }), _jsxs("div", { className: "gunma-profile-stat-grid", children: [_jsxs("div", { className: "gunma-profile-stat", children: [_jsx("span", { className: "v", children: metric.orders_count ?? 0 }), _jsx("span", { className: "l", children: "Orders" })] }), _jsxs("div", { className: "gunma-profile-stat", children: [_jsx("span", { className: "v", children: moneyFmt(metric.total_spent) }), _jsx("span", { className: "l", children: "Total Spent" })] }), _jsxs("div", { className: "gunma-profile-stat", children: [_jsx("span", { className: "v", children: moneyFmt(metric.avg_order) }), _jsx("span", { className: "l", children: "Avg Order" })] }), _jsxs("div", { className: "gunma-profile-stat", children: [_jsx("span", { className: "v", children: metric.cart_items ?? 0 }), _jsx("span", { className: "l", children: "In Cart" })] }), _jsxs("div", { className: "gunma-profile-stat", children: [_jsx("span", { className: "v", children: cust?.points ?? 0 }), _jsx("span", { className: "l", children: "Points" })] }), _jsxs("div", { className: "gunma-profile-stat", children: [_jsx("span", { className: "v", children: metric.messages_count ?? 0 }), _jsx("span", { className: "l", children: "Messages" })] })] })] }), _jsxs("div", { className: "gunma-profile-block", children: [_jsxs("h3", { children: [_jsx(UserCircle, { size: 14 }), " Profile"] }), _jsxs("div", { className: "gunma-profile-row", children: [_jsx("label", { children: "Name" }), _jsx("span", { children: title })] }), _jsxs("div", { className: "gunma-profile-row", children: [_jsx("label", { children: "Email" }), _jsx("span", { children: cust?.email || profile?.session?.customer_email || '—' })] }), _jsxs("div", { className: "gunma-profile-row", children: [_jsx("label", { children: "Phone" }), _jsx("span", { children: cust?.phone || '—' })] }), _jsxs("div", { className: "gunma-profile-row", children: [_jsx("label", { children: "Country" }), _jsx("span", { children: cust?.country || '—' })] }), _jsxs("div", { className: "gunma-profile-row", children: [_jsx("label", { children: "Language" }), _jsx("span", { children: cust?.native_language || '—' })] }), _jsxs("div", { className: "gunma-profile-row", children: [_jsx("label", { children: "Wallet" }), _jsx("span", { children: moneyFmt(cust?.wallet) })] }), _jsxs("div", { className: "gunma-profile-row", children: [_jsx("label", { children: "Joined" }), _jsx("span", { children: cust?.joined_at ? new Date(cust.joined_at).toLocaleDateString() : '—' })] }), _jsxs("div", { className: "gunma-profile-row", children: [_jsx("label", { children: "Channel" }), _jsx("span", { className: "status-badge", children: profile?.session?.channel })] })] }), _jsxs("div", { className: "gunma-profile-block", children: [_jsxs("h3", { children: [_jsx(Eye, { size: 14 }), " Behaviour"] }), _jsxs("div", { className: "gunma-profile-row", children: [_jsx("label", { children: "First seen" }), _jsx("span", { children: activity.first_seen ? new Date(activity.first_seen).toLocaleString() : '—' })] }), _jsxs("div", { className: "gunma-profile-row", children: [_jsx("label", { children: "Last seen" }), _jsx("span", { children: activity.last_seen ? new Date(activity.last_seen).toLocaleString() : '—' })] }), _jsx("div", { style: { marginTop: 8 }, children: _jsx("div", { className: "gunma-profile-chips", children: Object.entries(activity.by_action || {}).map(([k, v]) => (_jsxs("span", { className: "gunma-profile-chip", children: [k, ": ", String(v)] }, k))) }) }), (activity.recent_searches || []).length > 0 && (_jsxs("div", { style: { marginTop: 10 }, children: [_jsx("label", { style: { fontSize: 12, color: 'var(--text-muted)' }, children: "Recent searches" }), _jsx("div", { className: "gunma-profile-chips", style: { marginTop: 4 }, children: activity.recent_searches.map((s, i) => (_jsx("span", { className: "gunma-profile-chip", children: s }, i))) })] }))] }), _jsxs("div", { className: "gunma-profile-block", children: [_jsxs("h3", { children: [_jsx(Package, { size: 14 }), " Recent Orders (", (profile?.orders || []).length, ")"] }), (profile?.orders || []).length === 0 ? (_jsx("p", { className: "gunma-profile-empty", children: "No orders yet." })) : (_jsx("div", { className: "gunma-profile-list", children: profile.orders.map((o) => (_jsxs("div", { className: "gunma-profile-order", children: [_jsxs("div", { className: "top", children: [_jsxs("span", { children: ["#", o.id] }), _jsx("span", { children: moneyFmt(o.total_amount) })] }), _jsxs("div", { className: "meta", children: [o.status, " \u00B7 ", o.payment_method || '—', " \u00B7 ", o.payment_status || '—', o.delivery_date ? ` · 📅 ${o.delivery_date}` : ''] })] }, o.id))) }))] }), _jsxs("div", { className: "gunma-profile-block", children: [_jsxs("h3", { children: [_jsx(ShoppingCart, { size: 14 }), " Current Cart (", (profile?.cart || []).length, ")"] }), (profile?.cart || []).length === 0 ? (_jsx("p", { className: "gunma-profile-empty", children: "No active cart items." })) : (_jsx("div", { className: "gunma-profile-list", children: profile.cart.map((c, i) => (_jsxs("div", { className: "gunma-profile-order", children: [_jsxs("div", { className: "top", children: [_jsx("span", { children: c.title || `#${c.product_id}` }), _jsx("span", { children: moneyFmt(c.line_total) })] }), _jsxs("div", { className: "meta", children: ["Qty ", c.quantity, " \u00D7 ", moneyFmt(c.price)] })] }, i))) }))] }), _jsxs("div", { className: "gunma-profile-block wide", children: [_jsxs("h3", { children: [_jsx(MapPin, { size: 14 }), " Saved Addresses (", (profile?.addresses || []).length, ")"] }), (profile?.addresses || []).length === 0 ? (_jsx("p", { className: "gunma-profile-empty", children: "No saved addresses." })) : (_jsx("div", { className: "gunma-profile-list", children: profile.addresses.map((a, i) => (_jsxs("div", { className: "gunma-profile-order", children: [_jsxs("div", { className: "top", children: [_jsxs("span", { children: [a.name, " ", a.is_default ? '⭐' : ''] }), _jsx("span", { children: a.phone })] }), _jsxs("div", { className: "meta", children: ["\u3012", a.postal_code, " ", [a.state, a.city, a.street, a.apartment].filter(Boolean).join(', ')] })] }, i))) }))] }), _jsxs("div", { className: "gunma-profile-block wide", children: [_jsxs("h3", { children: [_jsx(Star, { size: 14 }), " Recent Activity (", (activity.recent || []).length, ")"] }), (activity.recent || []).length === 0 ? (_jsx("p", { className: "gunma-profile-empty", children: "No tracked activity." })) : (_jsx("div", { className: "gunma-profile-list", children: activity.recent.map((a, i) => (_jsxs("div", { className: "gunma-profile-activity", children: [_jsx("span", { className: "a", children: a.action }), _jsxs("span", { className: "gunma-profile-empty", children: [a.query ? `"${a.query}" · ` : '', a.page_url || ''] }), _jsx("span", { className: "gunma-profile-empty", children: new Date(a.logged_at).toLocaleString() })] }, i))) }))] })] }))] }) }));
}
